...
@EnableJpaRepositories(
    basePackages = {"com.asimily.dao"},
    entityManagerFactoryRef = "entityManagerFactory",
    transactionManagerRef = PersistenceAppConstants.TRANSACTION_MANAGER)
public class EclipselinkJpaAutoconfiguration extends JpaBaseConfiguration {

  final static Logger logger = LoggerFactory.getLogger(EclipselinkJpaAutoconfiguration.class);

  @Autowired
  static AsimilyDataSourceProperties asimilyDataSourceProperties;

  protected EclipselinkJpaAutoconfiguration(@Qualifier("dataSource") DataSource dataSource,
  ...
  public static org.apache.tomcat.jdbc.pool.DataSource dataSource(AsimilyDataSourceProperties properties) {
  ...
  protected static <T> T createDataSource(AsimilyDataSourceProperties properties, Class<? extends DataSource> type) {
  ...
  public LocalContainerEntityManagerFactoryBean primaryEntityManager(
    ...
    em.setPackagesToScan("com.asimily.models");
    em.setPersistenceUnitName(PersistenceAppConstants.PERSISTENCE_UNITNAME);
    return em;
  }
  ...
  @Primary
  @Bean(name = PersistenceAppConstants.TRANSACTION_MANAGER)
  public PlatformTransactionManager transactionManager(
      @Qualifier("entityManagerFactory") EntityManagerFactory emf, @Qualifier("dataSource") DataSource dataSource) {
