...
/**
 * The persistent class for the device_info_view database view.
 * 
 */
// @Multitenant
...
@Cacheable(false)
@Entity
@Table(name = "device_info_view", schema = "portal")
...
public class EDeviceInfoView extends ETenantBase {
