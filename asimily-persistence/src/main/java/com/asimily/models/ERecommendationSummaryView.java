...
@Entity
@Table(name = "recommendation_summary_view", schema = "portal")
public class ERecommendationSummaryView extends ETenantBase {
  ...
  /*@Column(name = "fixed_device_count")
  private Long fixedDeviceCount;

  @Column(name = "fixed_cve_count")
  private Long fixedCveCount;*/
  ...
  /*public Long getFixedDeviceCount() {
    return fixedDeviceCount;
  }

  public void setFixedDeviceCount(Long fixedDeviceCount) {
    this.fixedDeviceCount = fixedDeviceCount;
  }

  public Long getFixedCveCount() {
    return fixedCveCount;
  }

  public void setFixedCveCount(Long fixedCveCount) {
    this.fixedCveCount = fixedCveCount;
  }*/
